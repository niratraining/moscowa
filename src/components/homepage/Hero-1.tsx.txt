...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container-page relative z-10 flex h-full flex-col justify-end pb-10 pt-10 sm:pb-12 sm:pt-12 lg:pb-14 lg:pt-14">
        <div className="mb-6 motion-safe:animate-fade-up motion-safe:[animation-delay:120ms] sm:mb-7 lg:mb-8">
